...
class Crawling extends CI_Controller
{
    ...
    public function showResult()
    {
        ...
        // $a = "aku anak yang sehat";


        // echo $textWithoutLastWord;
...
//        }
        ...
        for ($i=0;$i<2;$i++){
            ...
            // $google_url2 = "https://www.googleapis.com/customsearch/v1?num=".$total."&start=".$start."&key=AIzaSyCqjhiFcTF4jyqDb-Cre5U_Ko255fe5aZ0&cx=009697247467493233773:yzx7ibazkgk&q=".$search_query2;
            // $google_url3 = "https://www.googleapis.com/customsearch/v1?num=".$total."&start=".$start."&key=AIzaSyCqjhiFcTF4jyqDb-Cre5U_Ko255fe5aZ0&cx=009697247467493233773:yzx7ibazkgk&q=".$search_query3;
            // $google_url4 = "https://www.googleapis.com/customsearch/v1?num=".$total."&start=".$start."&key=AIzaSyCqjhiFcTF4jyqDb-Cre5U_Ko255fe5aZ0&cx=009697247467493233773:yzx7ibazkgk&q=".$search_query4;
            // $google_url5 = "https://www.googleapis.com/customsearch/v1?num=".$total."&start=".$start."&key=AIzaSyCqjhiFcTF4jyqDb-Cre5U_Ko255fe5aZ0&cx=009697247467493233773:yzx7ibazkgk&q=".$search_query5;
            ...
            // $google_url2 = "https://www.googleapis.com/customsearch/v1?num=".$total."&start=".$start."&key=AIzaSyCcomXXfI2KsOdURy-YGEOnVA4dLw7336E&cx=013263571767881537586:w2jkjyd8pis&q=".$search_query2;
            // $google_url3 = "https://www.googleapis.com/customsearch/v1?num=".$total."&start=".$start."&key=AIzaSyCcomXXfI2KsOdURy-YGEOnVA4dLw7336E&cx=013263571767881537586:w2jkjyd8pis&q=".$search_query3;
            // $google_url4 = "https://www.googleapis.com/customsearch/v1?num=".$total."&start=".$start."&key=AIzaSyCcomXXfI2KsOdURy-YGEOnVA4dLw7336E&cx=013263571767881537586:w2jkjyd8pis&q=".$search_query4;
            // $google_url5 = "https://www.googleapis.com/customsearch/v1?num=".$total."&start=".$start."&key=AIzaSyCcomXXfI2KsOdURy-YGEOnVA4dLw7336E&cx=013263571767881537586:w2jkjyd8pis&q=".$search_query5;
...
//punya fadli
    public function showResultSentimen()
    {
        ...
        $keyword = $keyword1." ".$tanggal1;
        // $keywordrival = $textWithoutLastWord." "."jne"." ".$tanggal1;
        // $keywordrival2 = $textWithoutLastWord." "."wahana"." ".$tanggal1;
        // $keywordrival3 = $textWithoutLastWord." "."j&t"." ".$tanggal1;
        // $keywordrival4 = $textWithoutLastWord." "."pos indonesia"." ".$tanggal1;
