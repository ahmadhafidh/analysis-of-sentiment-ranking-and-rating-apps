            ...
            <div class="box-body">
              <div class="row">
                <div class="col-xs-4"><label>Author</label>
                  <?php echo form_input($author,$blog->author); ?>
                </div>
                <div class="col-xs-4"><label>Kategori</label>
                  <?php echo form_dropdown('',$get_combo_kategori,$blog->kategori,$kategori_css);?>
                </div>
                <div class="col-xs-4"><label>Status Publish</label>
                  <?php echo form_dropdown('', $publish_option, $blog->publish, $publish_css); ?>
                </div>
              </div><br>
              <div class="form-group"><label>Gambar Sebelumnya</label><br>
                <img src="<?php echo base_url('assets/images/blog/'.$blog->userfile.$blog->userfile_type.'') ?>" width="200px"/>
              </div>
