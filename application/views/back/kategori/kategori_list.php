    ...
    <div class="box box-primary">
      <div class="box-body table-responsive padding">
        <a href="<?php echo base_url('admin/kategori/create') ?>">
          <button class="btn btn-success"><i class="fa fa-plus"></i> Tambah Kategori Baru</button>
        </a> 
        ...
        <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
          ...
          <tbody>
            <?php
            $no=0;
            foreach ($kategori_data as $kategori){ $no++;?>
            <tr>
              <td style="text-align:center"><?php echo $no; ?></td>
              <td style="text-align:center"><?php echo $kategori->judul_kategori ?></td>
