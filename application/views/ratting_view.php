...
<div class="col-md-12">
   <div class="row">
    ...
    <div class="col-md-4">
      <?php
        $aff = $this->db->query('SELECT `nilai` FROM `nilai` WHERE id=2')->result_array();
    ...
    <div class="col-md-4">
      <?php
        $aff = $this->db->query('SELECT `nilai` FROM `nilai` WHERE id=3')->result_array();
    ...
    <div class="col-md-4">
      <?php
        $aff = $this->db->query('SELECT `nilai` FROM `nilai` WHERE id=4')->result_array();
    ...
    <div class="col-md-4">
      <?php
        $aff = $this->db->query('SELECT `nilai` FROM `nilai` WHERE id=5')->result_array();
